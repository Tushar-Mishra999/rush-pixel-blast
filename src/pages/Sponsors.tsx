...
const sponsorTiers = [{
  ...
  sponsors: [{
    name: "Event Partner 1",
    logo: null
  }, {
    name: "Event Partner 2",
    logo: null
  }, {
    name: "Event Partner 3",
    logo: null
  }, {
    name: "Event Partner 4",
    logo: null
  }, {
    name: "Event Partner 5",
    logo: null
  }]
}];
const Sponsors = () => {
          ...
          <div className="container px-4">
            ...
            <div className="flex justify-center items-stretch gap-8 md:gap-16 flex-wrap max-w-4xl mx-auto">
              ...
              <div className="flex flex-col items-center gap-4">
                <h3 className="font-heading text-base md:text-xl text-primary tracking-wider" style={{ textShadow: "0 0 10px hsl(var(--primary) / 0.5)" }}>
                  BPCL ASSOCIATE SPONSOR
                </h3>
                <div className="w-80 h-52 md:w-[27rem] md:h-64 border-2 border-primary/50 bg-card/60 backdrop-blur-sm flex items-center justify-center p-4 hover:border-primary transition-all duration-300" style={{ boxShadow: "0 0 20px hsl(var(--primary) / 0.2)" }}>
              ...
              <div className="flex flex-col items-center gap-4">
                <h3 className="font-heading text-base md:text-xl text-accent tracking-wider" style={{ textShadow: "0 0 10px hsl(var(--accent) / 0.5)" }}>
                  JHARKHAND TOURISM TITLE SPONSOR
                </h3>
                <div className="w-80 h-52 md:w-[27rem] md:h-64 border-2 border-accent/50 bg-card/60 backdrop-blur-sm flex items-center justify-center p-4 hover:border-accent transition-all duration-300" style={{ boxShadow: "0 0 20px hsl(var(--accent) / 0.2)" }}>
        ...
        <section className="py-16 bg-background border-b-2 border-border">
          <div className="container px-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              ...
              number: "11",
              label: "Years of Successful Celebrations"
            }, {
              number: "50+",
              label: "Past Participating B-Schools"
            }, {
              number: "250+",
              label: "Trusted Past Sponsors"
            }, {
              number: "2000+",
              label: "Footfall Every Year"
            }, {
              number: "15+",
              label: "Artists from the Industry Hosted"
            }].map((stat, index) => <div key={index} className="border-2 border-primary/30 p-6 text-center hover:border-primary transition-colors hover:bg-primary/5">
        ...
        <section className="py-16 bg-card border-b-2 border-border">
          <div className="container px-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
              ...
              number: "37K+",
              label: "Views on Top Reels"
            }, {
              number: "500K+",
              label: "Views on RUSH page in 2024"
            }, {
              number: "118K+",
              label: "Views on Top Videos - YouTube"
            }, {
              number: "1K+",
              label: "Students on Campus"
            }].map((stat, index) => <div key={index} className="border-2 border-accent/30 p-6 text-center hover:border-accent transition-colors hover:bg-accent/5">
          ...
          <div className="container px-4">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="border-2 border-accent p-8 bg-accent/5 relative overflow-hidden">
                ...
                <h3 className="font-heading text-xl md:text-2xl text-accent text-center mb-8" style={{
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {["Logos on main Banner, Poster and Newspaper", "Logos on all kind of entry passes (Back Side)", "Standees in the premiere locations on the campus", "Logos on event posters and banners", "Logos on all kind of entry passes (Front Side)", "Social media promotion through posters", "Website Promotion", "Feature in our official after-movie", "Exclusive In-store / promo video", "Exclusive social-media mention", "Permission to setup stalls/canopies (02)", "Shout-out at the events", "Permission to distribute products and materials", "Permission to setup Selfie-point", "Permission to promote in campus digital screen", "VIP Passes (20)", "Logos on participants' and winners' certificate", "Shoutout at the Opening Ceremony", "Sticker on audience seat cover", "Logo on merchandise"].map((benefit, index) => <div key={index} className="flex items-center gap-3 p-3 border border-accent/30 bg-accent/5 hover:bg-accent/10 transition-colors">
            ...
            <div className="max-w-4xl mx-auto mt-12">
              <div className="border-2 border-primary p-8 bg-primary/5 relative overflow-hidden">
                ...
                <h3 className="font-heading text-xl md:text-2xl text-primary text-center mb-8" style={{
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {["Logos on main Banner, Poster and Newspaper", "Logos on all kind of entry passes (Back Side)", "Standees in the premiere locations on the campus", "Logos on event posters and banners", "Logos on all kind of entry passes (Front Side)", "Social media promotion through posters", "Website Promotion", "Feature in our official after-movie", "Exclusive In-store / promo video", "Permission to setup stalls/canopies (01)", "Shout-out at the events", "Permission to distribute products and materials", "Permission to setup Selfie-point", "Permission to promote in campus digital screen", "VIP Passes (15)", "Logos on participants' and winners' certificate", "Shoutout at the Opening Ceremony", "Sticker on audience seat cover"].map((benefit, index) => <div key={index} className="flex items-center gap-3 p-3 border border-primary/30 bg-primary/5 hover:bg-primary/10 transition-colors">
            ...
            <div className="max-w-4xl mx-auto mt-12">
              <div className="border-2 border-secondary p-8 bg-secondary/5 relative overflow-hidden">
                ...
                <h3 className="font-heading text-xl md:text-2xl text-magenta text-center mb-8" style={{
                textShadow: "0 0 20px hsl(var(--magenta) / 0.5)"
              }}>
                  Associate Sponsor
                </h3>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {["Logos on main Banner, Poster and Newspaper", "Logos on all kind of entry passes (Back Side)", "Standees in the premiere locations on the campus", "Social media promotion through posters", "Website Promotion", "Feature in our official after-movie", "Permission to setup stalls/canopies (01)", "Shout-out at the events", "Permission to distribute products and materials", "VIP Passes (10)"].map((benefit, index) => <div key={index} className="flex items-center gap-3 p-3 border border-magenta/30 bg-magenta/5 hover:bg-magenta/10 transition-colors">
                      <span className="w-2 h-2 bg-magenta flex-shrink-0" style={{
                    boxShadow: "0 0 8px hsl(var(--magenta))"
                  }} />
                      <span className="font-subheading text-sm text-foreground">
                        {benefit}
                      </span>
            ...
            <div className="max-w-4xl mx-auto mt-12">
              <div className="border-2 border-green p-8 bg-card relative overflow-hidden">
                ...
                <h3 className="font-heading text-xl md:text-2xl text-green text-center mb-8" style={{
                textShadow: "0 0 20px hsl(var(--green) / 0.5)"
              }}>
                  Event Sponsor
                </h3>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {["Logos on main Banner, Poster and Newspaper", "Logos on all kind of entry passes (Back Side)", "Social media promotion through posters", "Website Promotion", "Shout-out at the events", "VIP Passes (5)", "Logos on participants' and winners' certificate"].map((benefit, index) => <div key={index} className="flex items-center gap-3 p-3 border border-green/30 bg-green/5 hover:bg-green/10 transition-colors">
                      <span className="w-2 h-2 bg-green flex-shrink-0" style={{
                    boxShadow: "0 0 8px hsl(var(--green))"
                  }} />
                      <span className="font-subheading text-sm text-foreground">
                        {benefit}
                      </span>
            ...
            {/* Partnerships Card */}
            <div className="max-w-4xl mx-auto mt-12">
              <div className="border-2 border-accent p-8 bg-accent/5 relative overflow-hidden" style={{
              boxShadow: "0 0 30px hsl(var(--accent) / 0.3)"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {["Food & Beverage Partner", "Radio Partner", "Gift Partner", "Fashion Partner", "Print Media Partner", "Travel Partner", "Hospitality Partner", "Beauty Partner"].map((partner, index) => <div key={index} className="flex items-center gap-3 p-3 border border-accent/30 bg-accent/5 hover:bg-accent/10 transition-colors">
                      <span className="w-2 h-2 bg-accent flex-shrink-0" style={{
